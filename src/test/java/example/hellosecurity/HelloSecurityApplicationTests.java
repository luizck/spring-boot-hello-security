...
class HelloSecurityApplicationTests {
	...
	@SystemStub
	final EnvironmentVariables environment = new EnvironmentVariables("HELLO_SECURITY_MYVAR", "is set");

	@Nested
	@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
	@AutoConfigureWebTestClient
	class NestedHelloSecurityApplicationTests {
		...
		void testEnvironmentVariables() {
			assertThat(System.getenv("HELLO_SECURITY_MYVAR")).isEqualTo("is set");
		}
